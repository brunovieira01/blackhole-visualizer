...
|---|---|---|
| Right for a while, then partway through it snaps back to the start and stays wrong | The player's reported position jumped backwards — the probe counts this and says so | The timeline interpolation; fixed, and the probe guards it |
